...
public class C06_Encapsulation {
    ...
    yetkilerini biribirinden bagimsiz olarak duzenlemek istenebilir

    Access modifier ile class uyelerine baska class'lardan erisim sinirlandirililabilir
    ANCAK
    ulasiliabilen dataya hem okuma hem yazma yapilabilirken
    ...
    -Eger okuma ve yazma yetkileri birbbirinden ayrilacaksa
    o zamn access modifier yeterli olmaz
    Encapsulation(getter ve setter method'lari) kullanilmaktadir
     */
